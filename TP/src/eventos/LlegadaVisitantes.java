...
public class LlegadaVisitantes implements Cloneable {
    
    private double rnd;
    private double tiempo_entre_llegadas;
    private double prox_llegada;
    
    public LlegadaVisitantes() {
        rnd = tiempo_entre_llegadas = prox_llegada = Double.MAX_VALUE;
    }

    public LlegadaVisitantes(double rnd, double tiempo_entre_llegadas, double prox_llegada) {
        this.rnd = rnd;
    ...
    @Override
    public LlegadaVisitantes clone() {
        try {
            LlegadaVisitantes clon = (LlegadaVisitantes) super.clone();
            ...
            Logger.getLogger(LlegadaVisitantes.class.getName()).log(Level.SEVERE, null, ex);
        }
        return new LlegadaVisitantes();
    }
